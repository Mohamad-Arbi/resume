            ...
            <svg className={styles.logo} width="120" height="120" viewBox="0 0 120 120" fill="none"
                ...
                <g className={styles.outer}>
                    <g className={styles.spin}>
                        <text fontSize="9" fontWeight="700" fill="black" letterSpacing="0.86">
                            <textPath href="#textCircle" textLength="295" lengthAdjust="spacing">
                                {'MOHAMED ARBI  •  MOHAMED ARBI  •  MOHAMED ARBI  • '}
                            </textPath>
                        </text>
                    </g>
                </g>

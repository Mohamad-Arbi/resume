        ...
        <section className={styles.section}>
            <Container className={styles.grid}>
                <TextReveal className={styles.paragraph}>
                    I&apos;ve worked across backend and frontend development, so I can
                    understand system architectures well and build effective solutions within teams.
                </TextReveal>
                <h2 className={styles.boldTitle} ref={boldTitle}>
                    <span className={styles.boldTitleLeft} ref={boldTitleLeft}>Full-Stack</span>
                    <span>Software</span>
                    <span className={styles.boldTitleRight} ref={boldTitleRight}>Engineer</span>
                </h2>
                <TextReveal className={`${styles.paragraph} ${styles.paragraphAlt}`}>
                    Currently, I live in Sfax, Tunisia. I&apos;m pursuing my engineering degree in Software &
                    Decision Information Systems while working as a developer and technical assistant.
                </TextReveal>

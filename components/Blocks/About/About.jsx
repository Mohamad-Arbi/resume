    ...
    return (
        <section className={styles.section}>
            <div className={styles.grid}>
                ...
                <header className={styles.header}>
                    ...
                    <TextReveal className={styles.description}>
                        Software engineering student with hands-on experience in full-stack development using Java, SpringBoot, Angular, and Laravel.
                    </TextReveal>
                </header>
            ...
            <div className={styles.grid}>
                <header className={styles.header}>
                    <TextReveal className={styles.description}>
                        I&apos;ve worked across backend and frontend development, so I can understand system architectures well and build effective solutions within teams.
                    </TextReveal>
                </header>
            ...
            <div className={styles.grid}>
                <header className={styles.header}>
                    <TextReveal className={styles.description}>
                        Currently, I live in Sfax, Tunisia. I&apos;m pursuing my engineering degree in Software & Decision Information Systems while working as a developer and technical assistant.
                    </TextReveal>
                </header>

                    ...
                    <div className={styles.cardGroup} ref={cardGroup}>
                        <div className={`${styles.card} ${styles.cardV1}`}>
                            <div className={styles.cardInner}>
                                <div className={styles.cardTitle}>MOHAMED ARBI TLILI</div>
                                <div className={styles.cardDesc}>Engineering Student in Software & Decision Systems</div>
                                <hr/>
                                <p>Holder of a degree in Software Engineering & Information Systems from IIT Sfax.
                                    Currently pursuing a 3rd-year engineering degree in Software & Decision Information Systems.
                                    Passionate about full-stack development with Java, SpringBoot, Angular, and AI integration.
                                </p>
                                <div>
                                ...
                                <p>
                                    Developer & Technical Assistant (CDI) | ISB <br/>
                                    Full-Stack Developer (PFA) | IIT <br/>
                                    Full-Stack Developer (PFE) | Dk Soft <br/>
                                    Software Developer (PFA) | OACA
                                </p>
                            </div>
                            <figure className={styles.figure}>
                                <Image src="/mohamed-arbi-photo.png" alt="Mohamed Arbi Tlili" width={150} height={150}/>
                            </figure>
                        </div>
